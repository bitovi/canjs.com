/*view/autorender/autorender*/
'format steal';
define('can/view/autorender', ['can/util/library'], function (can) {
    ...
    function autoload() {
        ...
        can.each(can.$('[can-autorender]'), function (el, i) {
            ...
            var text = el.innerHTML || el.text, typeAttr = el.getAttribute('type'), typeInfo = typeAttr.match(typeMatch), type = typeInfo && typeInfo[1];
