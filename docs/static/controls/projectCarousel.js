define(["can/","can/util/function/",'jqueryui'], function(can){

	return can.Control.extend('Bitovi.OSS.ProjectCarousel', { 
	  defaults: {
	  ...
	  init: function(el, options) {
	    ...
	    Bitovi.OSS.App.findAll({limit: 300, size: 'canjscom'}).then(can.proxy(function(apps) {
	      var len = apps.length;
